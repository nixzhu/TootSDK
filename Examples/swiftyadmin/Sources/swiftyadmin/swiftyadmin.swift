...
struct SwiftyAdmin: AsyncParsableCommand {
    static var configuration = CommandConfiguration(
        ...
        subcommands: [
            ...
            GetAnnualReports.self,
            GetAnnualReport.self,
            GetAnnualReportState.self,
            MarkAnnualReportRead.self,
            GenerateAnnualReport.self,
            GetAccountCollections.self,
            GetAccountInCollections.self,
            GetCollection.self,
            CreateCollection.self,
            UpdateCollection.self,
            DeleteCollection.self,
            AddAccountToCollection.self,
            RemoveCollectionItem.self,
            RevokeCollectionItem.self,
            GetProfile.self,
            UpdateProfile.self,
        ])
}
